...
import com.github.damianjester.nclient.api.components.Ranges;
...
import com.github.damianjester.nclient.async.VersionChecker;
import com.github.damianjester.nclient.async.database.Queries;
import com.github.damianjester.nclient.async.downloader.DownloadGalleryV2;
import com.github.damianjester.nclient.components.CookieInterceptor;
import com.github.damianjester.nclient.components.GlideX;
import com.github.damianjester.nclient.components.activities.BaseActivity;
import com.github.damianjester.nclient.components.views.PageSwitcher;
...
import com.github.damianjester.nclient.settings.Login;
...
import com.github.damianjester.nclient.utility.Utility;
...
public class MainActivity extends BaseActivity
    ...
    private void initializeNavigationView() {
        ...
        onlineFavoriteManager.setVisible(com.github.damianjester.nclient.settings.Login.isLogged());
    }
    ...
    private void loadStringLogin() {
        ...
        if (com.github.damianjester.nclient.settings.Login.getUser() != null)
            loginItem.setTitle(getString(R.string.login_formatted, com.github.damianjester.nclient.settings.Login.getUser().getUsername()));
        else
            loginItem.setTitle(com.github.damianjester.nclient.settings.Login.isLogged() ? R.string.logout : R.string.login);
    ...
    private void useDataSearchMode(Uri data, List<String> datas) {
        ...
        if (favorite) {
            if (com.github.damianjester.nclient.settings.Login.isLogged()) useFavoriteMode(page);
            else {
    ...
    protected void onResume() {
        ...
        com.github.damianjester.nclient.settings.Login.initLogin(this);
