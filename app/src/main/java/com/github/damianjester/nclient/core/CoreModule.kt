...
val coreModule = module {
    single { DefaultGallerySearchPager(get(), get(), get(), get()) } bind GallerySearchPager::class
    single { DefaultGallerySearchObserver(get()) } bind GallerySearchObserver::class

    single { DefaultGalleryDetailsFetcher(get(), get(), get(), get()) } bind GalleryDetailsFetcher::class
