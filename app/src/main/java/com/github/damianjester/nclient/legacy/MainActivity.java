...
import com.github.damianjester.nclient.legacy.api.components.Ranges;
import com.github.damianjester.nclient.legacy.api.components.Tag;
import com.github.damianjester.nclient.legacy.api.enums.ApiRequestType;
import com.github.damianjester.nclient.legacy.api.enums.Language;
import com.github.damianjester.nclient.legacy.api.enums.SortType;
import com.github.damianjester.nclient.legacy.api.enums.SpecialTagIds;
import com.github.damianjester.nclient.legacy.api.enums.TagStatus;
...
import com.github.damianjester.nclient.legacy.async.VersionChecker;
...
import com.github.damianjester.nclient.legacy.components.CookieInterceptor;
import com.github.damianjester.nclient.legacy.components.GlideX;
...
public class MainActivity extends BaseActivity
    ...
    private void initializeNavigationView() {
        ...
        onlineFavoriteManager.setVisible(Login.isLogged());
    }
    ...
    private void loadStringLogin() {
        ...
        if (Login.getUser() != null)
            loginItem.setTitle(getString(R.string.login_formatted, Login.getUser().getUsername()));
        else
            loginItem.setTitle(Login.isLogged() ? R.string.logout : R.string.login);
